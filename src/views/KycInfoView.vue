...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (response.ok && data.code === 0) {
      alert('KYC information verified and saved successfully!')
      router.push('/account')
    } else {
      errorMessage.value = handleApiError(data) || 'Verification failed. Please check your information.'
      ...
      <div class="col-md-8 col-lg-6">
        <div class="card shadow-lg border-0 rounded-3">
          <div class="card-body p-5">
            <h3 class="text-center fw-bold text-primary mb-4">Complete Verification</h3>
            <p class="text-muted text-center mb-4">
              Please enter your personal information exactly as it appears on your ID document.
            </p>
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" v-model="formData.last_name" required placeholder="e.g. Wang">
                </div>
                <div class="col-md-6">
